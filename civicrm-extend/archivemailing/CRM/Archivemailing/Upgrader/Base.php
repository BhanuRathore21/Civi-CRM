 ...
 */
class CRM_Archivemailing_Upgrader_Base {

  /**
   * @var CRM_Archivemailing_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Archivemailing_Upgrader(
        'archivemailing',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Archivemailing_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Archivemailing_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
